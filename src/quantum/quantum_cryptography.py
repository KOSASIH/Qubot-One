# src/quantum/quantum_cryptography.py
...
class QuantumCryptography:
    def __init__(self):
        """Initialize the Quantum Cryptography class with the Aer simulator."""
...
if __name__ == "__main__":
    ...
    cryptography.simulate_bb84()
    cryptography.simulate_quantum_teleportation()
